...
! function (t, i) {
	...
	function O(t, i, n) {
		...
		t["_leaflet_touchstart" + n] = o, t.addEventListener(te, o, !1), re || (document.documentElement.addEventListener(te, R, !0), document.documentElement.addEventListener(ie, D, !0), document.documentElement.addEventListener(ee, N, !0), document.documentElement.addEventListener(ne, N, !0), re = !0)
	}
	...
	function U(t, i) {
		var e = t[le + he + i],
			n = t[le + ue + i],
			o = t[le + "dblclick" + i];
		return t.removeEventListener(he, e, !1), t.removeEventListener(ue, n, !1), Li || t.removeEventListener("dblclick", o, !1), this
	}
	...
	function rt(t, i, e) {
		var n = i && i.round() || new x(0, 0);
		t.style[ce] = (Ri ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (e ? " scale(" + e + ")" : "")
	}

	function at(t, i, e) {
		t._leaflet_pos = i, !e && ji ? rt(t, i) : (t.style.left = i.x + "px", t.style.top = i.y + "px")
	}
	...
	function gt(t, i, e, o) {
		...
		var r = function (i) {
			...
			a = r;
		Vi && 0 === i.indexOf("touch") ? A(t, i, r, s) : !qi || "dblclick" !== i || !F || Vi && ki ? "addEventListener" in t ? "mousewheel" === i ? t.addEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : "mouseenter" === i || "mouseleave" === i ? (r = function (i) {
	...
	function vt(t, i, e, o) {
		var s = i + n(e) + (o ? "_" + n(o) : ""),
			r = t[ye] && t[ye][s];
		if (!r) return this;
		Vi && 0 === i.indexOf("touch") ? I(t, i, s) : !qi || "dblclick" !== i || !U || Vi && ki ? "removeEventListener" in t ? "mousewheel" === i ? t.removeEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1) : t.removeEventListener("mouseenter" === i ? "mouseover" : "mouseleave" === i ? "mouseout" : i, r, !1) : "detachEvent" in t && t.detachEvent("on" + i, r) : U(t, s), t[ye][s] = null
	}
	...
	function Tt(t) {
		return Li ? t.wheelDeltaY / 2 : t.deltaY && 0 === t.deltaMode ? -t.deltaY / xe : t.deltaY && 1 === t.deltaMode ? 20 * -t.deltaY : t.deltaY && 2 === t.deltaMode ? 60 * -t.deltaY : t.deltaX || t.deltaZ ? 0 : t.wheelDelta ? (t.wheelDeltaY || t.wheelDelta) / 2 : t.detail && Math.abs(t.detail) < 32765 ? 20 * -t.detail : t.detail ? t.detail / -32765 * 60 : 0
	}
	...
	function Zt(t, i) {
		var e = t.timeStamp || t.originalEvent && t.originalEvent.timeStamp,
			n = ge && e - ge;
		n && n > 100 && n < 500 || t.target._simulatedClick && !t._simulated ? bt(t) : (ge = e, i(t))
	}

	function St(t, i) {
		if (!i || !t.length) return t.slice();
		var e = i * i;
		return t = At(t, e), t = Et(t, e)
	}
	...
	function Bt(t, i, e, n, o) {
		var s, r, a, h = 0;
		for (r = n + 1; r <= o - 1; r++)(a = Nt(t[r], t[n], t[o], !0)) > h && (s = r, h = a);
	...
	var fi, gi, vi, yi = i({}, pi, {
		...
		bi = Pi && !document.addEventListener,
		...
		Zi = zi && B("Google") && Ci < 537 && !("AudioNode" in window),
		Si = !!window.opera,
		ki = B("chrome"),
		Ei = B("gecko") && !Ti && !Si && !Pi,
		Bi = !ki && B("safari"),
		...
		Di = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !Mi,
		Ni = "MozPerspective" in wi,
		ji = !window.L_DISABLE_3D && (Ri || Di || Ni) && !Ii && !Ai,
		Wi = "undefined" != typeof orientation || B("mobile"),
		Hi = Wi && Ti,
		Fi = Wi && Di,
		Ui = !window.PointerEvent && window.MSPointerEvent,
		Vi = !(!window.PointerEvent && !Ui) && window.W && "mobile" !== window.W.target && !B("iphone") && !("MacIntel" === navigator.platform && navigator.maxTouchPoints > 1),
		...
		Ji = !(!document.createElementNS || !k("svg").createSVGRect),
		$i = !Ji && function () {
			try {
	...
	var me, fe, ge, ve = (Object.freeze || Object)({
		...
		ye = "_leaflet_events",
		xe = Oi && ki ? 2 * window.devicePixelRatio : Ei ? window.devicePixelRatio : 1,
		we = {},
		...
		Le = ci.extend({
			...
			flyTo: function (t, i, e) {
				...
				var m = Math.max(d.x, d.y),
					...
					P = Date.now(),
					b = (n(1) - w) / y,
					L = e.duration ? 1e3 * e.duration : 1e3 * b * .8;
			...
			_initLayout: function () {
				...
				this._fadeAnimated = this.options.fadeAnimation && ji, Q(t, "leaflet-container" + (qi ? " leaflet-touch" : "") + (Yi ? " leaflet-retina" : "") + (bi ? " leaflet-oldie" : "") + (Bi ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
				var i = q(t, "position");
	...
	var Me = Te.extend({
			...
			_initLayout: function () {
				...
				o.href = "#", o.title = "Layers", qi ? (mt(o, "click", bt), mt(o, "click", this.expand, this)) : mt(o, "focus", this.expand, this), e || this.expand(), this._baseLayersList = G("div", t + "-base", n), this._separator = G("div", t + "-separator", n), this._overlaysList = G("div", t + "-overlays", n), i.appendChild(n)
			},
		...
		Ce = Te.extend({
			...
			_createButton: function (t, i, e, n, o) {
				var s = G("a", e, n);
				return s.innerHTML = t, s.href = "#", s.title = i, s.setAttribute("role", "button"), s.setAttribute("aria-label", i), wt(s), mt(s, "click", bt), mt(s, "click", o, this), mt(s, "click", this._refocusOnMap, this), s
			},
	...
	Te.Layers = Me, Te.Zoom = Ce, Te.Scale = Ze, Te.Attribution = Se, ze.layers = function (t, i, e) {
		return new Me(t, i, e)
	}, ze.zoom = function (t) {
		return new Ce(t)
	}, ze.scale = function (t) {
	...
	var Ge = qe.extend({
		...
		Qe = qe.extend({
			...
			setStyle: function (t) {
				return l(this, t), this._renderer && (this._renderer._updateStyle(this), this.options.stroke && t.hasOwnProperty("weight") && this._updateBounds()), this
			},
			bringToFront: function () {
		...
		nn = Qe.extend({
			...
			_updateBounds: function () {
				var t = this._clickTolerance(),
					i = new x(t, t);
				this._pxBounds = new P([this._rawPxBounds.min.subtract(i), this._rawPxBounds.max.add(i)])
			},
			...
			_simplifyPoints: function () {
				for (var t = this._parts, i = this.options.smoothFactor, e = 0, n = t.length; e < n; e++) t[e] = St(t[e], i)
			},
			_update: function () {
	...
	Le.mergeOptions({
		...
		_openPopup: function (t) {
			...
			this._popup && this._map && (bt(t), i instanceof Qe ? this.openPopup(t.layer || t.target, t.latlng) : this._map.hasLayer(this._popup) && this._popup._source === i ? this.closePopup() : this.openPopup(i, t.latlng))
		},
	...
	var pn = qe.extend({
			...
			_initTile: function (t) {
				...
				t.style.width = i.x + "px", t.style.height = i.y + "px", t.onselectstart = r, t.onmousemove = r, bi && this.options.opacity < 1 && nt(t, this.options.opacity), zi && !Mi && (t.style.WebkitBackfaceVisibility = "hidden")
			},
			_addTile: function (t, i) {
				var n = this._getTilePos(t),
					o = this._tileCoordsToKey(t),
					s = this.createTile(this._wrapCoords(t), e(this._tileReady, this, t));
				this._initTile(s), this.createTile.length < 2 && f(e(this._tileReady, this, t, null, s)), at(s, n, this.options.disableTransformForTiles), this._tiles[o] = {
					el: s,
					coords: t,
					current: !0
			...
			_tileReady: function (t, i, n) {
				...
				(n = this._tiles[o]) && (n.loaded = +new Date, this._map._fadeAnimated ? (nt(n.el, 0), g(this._fadeFrame), this._fadeFrame = f(this._updateOpacity, this)) : (n.active = !0, this._pruneTiles()), i || (Q(n.el, "leaflet-tile-loaded"), this.fire("tileload", {
					tile: n.el,
					coords: t
				})), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), bi || !this._map._fadeAnimated ? f(this._pruneTiles, this) : setTimeout(e(this._pruneTiles, this), 250)))
			},
		...
		mn = pn.extend({
			...
			_tileOnLoad: function (t, i) {
				bi ? setTimeout(e(t, this, null, i), 0) : t(null, i)
			},
			...
			_removeTile: function (t) {
				var i = this._tiles[t];
				if (i) return Zi || i.el.setAttribute("src", si), pn.prototype._removeTile.call(this, t)
			},
	...
	Pn.create = wn, Pn.pointsToPath = E, sn.geometryToLayer = Ft, sn.coordsToLatLng = Ut, sn.coordsToLatLngs = Vt, sn.latLngToCoords = qt, sn.latLngsToCoords = Gt, sn.getFeature = Kt, sn.asFeature = Yt, Le.mergeOptions({
		boxZoom: !0
	});
	var Ln = ke.extend({
		initialize: function (t) {
	...
	Le.addInitHook("addHandler", "doubleClickZoom", Tn), Le.mergeOptions({
		dragging: !0,
		inertia: !Mi,
	...
	Le.addInitHook("addHandler", "dragging", zn), Le.mergeOptions({
		keyboard: !0,
		keyboardPanDelta: 80
	});
	var Mn = ke.extend({
	...
	Le.addInitHook("addHandler", "keyboard", Mn), Le.mergeOptions({
		scrollWheelZoom: !0,
	...
	var Cn = ke.extend({
		...
		_onWheelScroll: function (t) {
			...
			clearTimeout(this._timer), this._timer = setTimeout(e(this._performZoom, this), o), bt(t)
		},
	...
	Le.addInitHook("addHandler", "scrollWheelZoom", Cn), Le.mergeOptions({
		tap: !0,
		tapTolerance: 15
	});
	var Zn = ke.extend({
	...
	qi && !Vi && Le.addInitHook("addHandler", "tap", Zn), Le.mergeOptions({
		touchZoom: qi && !Mi,
	...
	var Sn = ke.extend({
		...
		_onTouchMove: function (t) {
			if (t.touches && 2 === t.touches.length && this._zooming) {
				...
				if (this._zoom = i.getScaleZoom(s, this._startZoom), !i.options.bounceAtZoomLimits && (this._zoom < i.getMinZoom() && s < 1 || this._zoom > i.getMaxZoom() && s > 1) && (this._zoom = i._limitZoom(this._zoom)), i._zoomCenter) {
					var r = Math.round(this._zoom);
					return r !== i.getZoom() && r >= i.getMinZoom() && r <= i.getMaxZoom() && i.setZoomAround(i._zoomCenter, r, {
						animate: !0
					}), void Pt(t)
				}
				...
				var h = e(i._move, i, this._center, this._zoom, {
					pinch: !0,
					round: !1
				});
				this._animRequest = f(h, this, !0), Pt(t)
			}
		},
		_onTouchEnd: function () {
			this._moved && this._zooming ? (this._zooming = !1, g(this._animRequest), ft(document, "touchmove", this._onTouchMove), ft(document, "touchend", this._onTouchEnd), this._map._zoomCenter || (this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom)))) : this._zooming = !1
		}
	});
	Le.addInitHook("addHandler", "touchZoom", Sn), Le.BoxZoom = Ln, Le.DoubleClickZoom = Tn, Le.Drag = zn, Le.Keyboard = Mn, Le.ScrollWheelZoom = Cn, Le.Tap = Zn, Le.TouchZoom = Sn, Le.addInitHook(function () {
		function t() {
			null != e && (clearTimeout(e), e = null)
		}
		var e, n = this;
		n.on && (n.on("click", function (o) {
			t(), e = setTimeout(function () {
				n.fire("singleclick", i(o, {
					type: "singleclick"
				}))
			}, 500)
	...
	var kn = mn.extend({
		_tileDefs: [],
		initialize: function (t, i) {
			mn.prototype.initialize.call(this, void 0, i);
			var e = this.options.minZoom;
			for (var n in t)
				for (var o = this._fixTileDef(t[n]); e <= n; e++) this._tileDefs[e] = o
		},
		_fixTileDef: function (t) {
			var i = L.extend({}, {
				subdomains: L.TileLayer.prototype.options.subdomains
			}, t);
			return "string" == typeof i.subdomains && (i.subdomains = i.subdomains.split("")), i
		},
		_getSubdomain: function (t, i) {
			return i[(t.x + t.y) % i.length]
		},
		setUrl: function () {},
		getTileUrl: function (t) {
			var i = this._getZoomForUrl(),
				e = this._tileDefs[i];
			return _(e.url, L.extend({
				s: this._getSubdomain(t, e.subdomains),
				z: i,
				x: t.x,
				y: t.y
			}, this.options))
	...
	Object.freeze = ti, t.version = "1.4.0+master.22dc4d0b", t.TileLayerMulti = kn, t.tileLayerMulti = function (t, i) {
		return new kn(t, i)
	}, t.Control = Te, t.control = ze, t.Browser = Qi, t.Evented = ci, t.Mixin = Be, t.Util = ui, t.Class = v, t.Handler = ke, t.extend = i, t.bind = e, t.stamp = n, t.setOptions = l, t.DomEvent = Pe, t.DomUtil = ve, t.PosAnimation = be, t.Draggable = Re, t.LineUtil = De, t.PolyUtil = Ne, t.Point = x, t.point = w, t.Bounds = P, t.bounds = b, t.Transformation = Z, t.transformation = S, t.Projection = He, t.LatLng = M, t.latLng = C, t.LatLngBounds = T, t.latLngBounds = z, t.CRS = di, t.GeoJSON = sn, t.geoJSON = Xt, t.geoJson = an, t.Layer = qe, t.LayerGroup = Ge, t.layerGroup = function (t, i) {
		return new Ge(t, i)
		...
		return new on(t, i)
	}, t.Rectangle = bn, t.rectangle = function (t, i) {
		return new bn(t, i)
