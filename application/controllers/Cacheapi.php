...
class Cacheapi extends CI_Controller {
	...
	public function cacheweatherapi($change_date, $type, $s, $z, $x, $y, $file_name){
		...
		$Wind_Map = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/WS10/'.$z.'/'.$x.'/'.$y.'?appid='.$this->API_Openweathermap.'&opacity=1&fill_bound=true&palette='.$wind_color;
		$Temperature_Map = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/TA2/'.$z.'/'.$x.'/'.$y.'?appid='.$this->API_Openweathermap.'&fill_bound=true&opacity=1&palette='.$temperature_color;
		$Relative_Humidity = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/HRD0/'.$z.'/'.$x.'/'.$y.'?appid='.$this->API_Openweathermap.'&fill_bound=true&opacity=1&palette='.$humidity_color;
		$Accumulated_Precipitation_Rain = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/PAR0/'.$z.'/'.$x.'/'.$y.'?fill_bound=true&opacity=1&palette='.$rain_color.'&appid='.$this->API_Openweathermap;
		$Atmospheric_Pressure_Mean = 'https://a.sat.owm.io/vane/2.0/weather/APM/'.$z.'/'.$x.'/'.$y.'?appid='.$this->API_Openweathermap.'&fill_bound=true&opacity=1&palette='.$pressure_color;
		$Cloudiness = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/CL/'.$z.'/'.$x.'/'.$y.'?appid='.$this->API_Openweathermap.'&fill_bound=true&opacity=1&palette='.$cloud_color;
		...
		$SD0_url = 'https://'.$s.'.sat.owm.io/vane/2.0/weather/SD0/'.$z.'/'.$x.'/'.$y.'?fill_bound=true&opacity=1&appid='.$this->API_Openweathermap.'&palette='.$snow_color;
