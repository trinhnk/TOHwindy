...
function initWindyMap(){
    ...
    var Atmospheric_Pressure_Mean = L.tileLayer('http://cache.goweatherradar.com/cacheapi/getimage?url=http://maps.openweathermap.org/maps/2.0/weather/APM/{z}/{x}/{y}?fill_bound=true&opacity=1&pallette=990:8eb3b8;995:68b4b3;1000:45a7a6;1003:398393;1006:397693;1009:395b93;1015:3a7535;1019:9fa141;1022:ad8839;1025:aa5443;1030:5e3c51&appid='+API_Openweathermap,{
        maxZoom: 11,
        minZoom: 3,
    })
    var Cloudiness = L.tileLayer('http://cache.goweatherradar.com/cacheapi/getimage?url=http://maps.openweathermap.org/maps/2.0/weather/CL/{z}/{x}/{y}?fill_bound=true&opacity=1&pallette=0:928246;10:847746;30:747474;80:adb7b6;90:bec1c1;100:d5d5cd&appid='+API_Openweathermap,{
        maxZoom: 11,
        minZoom: 3,
    })
    var overlayLayer = {
    ...
    var Windy_Map = L.tileLayer('http://cache.goweatherradar.com/cacheapi/getimage?url=https://tiles.windy.com/tiles/v9.0/darkmap/{z}/{x}/{y}.png',{
        maxZoom: 11,
        minZoom: 3
    });
	var baseLayers = {
	...
	var geojsonTileLayer = new L.LoadCityNameJSON('http://cache.goweatherradar.com/cacheapi/getimage?url=https://tiles.windy.com/labels/v1.3/en/{z}/{x}/{y}.json',{
        maxZoom: 11,
        minZoom: 3,
    });
